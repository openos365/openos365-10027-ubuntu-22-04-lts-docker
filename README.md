# openos365-10027-ubuntu-22-04-lts-docker
...
docker run -it openos365/openos365-10027-ubuntu-22-04-lts-docker-main-root:latest bash
```
#### www

```
docker pull openos365/openos365-10027-ubuntu-22-04-lts-docker-main-www:latest
docker run -it openos365/openos365-10027-ubuntu-22-04-lts-docker-main-www:latest bash
```
